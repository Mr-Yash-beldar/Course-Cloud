...
<div class="col-lg-12">  
<h4>Mandate</h4>
    <p> Art Science and Commerce Collage Chopda (ASCC) primarily provides advance instruction and professional training science and technology, arts and humanities.</p> 
</div>
<div  class="col-lg-6">
  <h4>Vision</h4> 
  <p>Center of Academic Excellence Delivering Quality Service to all.</p>
  <h4>Mission</h4>
  <p> ASC Collage Chopda is committed to provide advanced knowledge and innovation; develop skills, talents and values; undertake relevant research; development and extension services; promote entrepreneurship and environmental consciousness; and enhance industry collaboration  & linkages with partner agencies.</p>
  <h4>Goals</h4> 
  <ol>
...
<ol>
    <li>ASC is committed to be the center of academic excellence delivering quality service to all by;</li> 
